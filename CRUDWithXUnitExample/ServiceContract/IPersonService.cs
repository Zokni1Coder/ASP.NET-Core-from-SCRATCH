...
namespace ServiceContract
{
    public interface IPersonService
    {
        ...
        public Task<PersonResponse> AddPerson(PersonAddRequest? personRequest);
        ...
        public Task<List<PersonResponse>> GetSortedPersons(List<PersonResponse> persons, string sortBy, SortingOptions sortingoption);
        ...
        public Task<PersonResponse> UpdatePerson(PersonUpdateRequest? requestPerson);
