...
namespace Service
{
    public class FinnhubService : IFinnhubService
    {
        ...
        public async Task<Dictionary<string, object>?> GetCompanyProfile(string stockSymbol)
        {
            ...
            using (client)
            {
                HttpRequestMessage httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, $"https://finnhub.io/api/v1/stock/profile2?symbol={stockSymbol}&token={this._configuration.GetSection("token")}");
